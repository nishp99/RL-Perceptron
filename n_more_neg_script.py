...
experiment_path = os.path.join(results_path, "n_case_neg_long")
...
with executor_1.batch():
	for n in n_s:
		job = executor_1.submit(n_or_more_neg_exp, D = 900, teacher = w_teacher, rad = student[0], student = student[1], T = T, n = n, lr_1 = 1, lr_2 = 0.05 , steps = 16000, experiment_path = run_path)
		jobs.append(job)
...
with executor_2.batch():
	for n in n_s:
		job_2 = executor_2.submit(n_or_more_neg, D = 900, teacher = w_teacher, rad = student[0], student = student[1], T = T, n = n, lr_1 = 1, lr_2 = 0.05, steps = 16000, experiment_path = run_path)
		jobs_2.append(job_2)
