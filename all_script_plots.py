...
experiment_path = os.path.join(results_path, "neg_all_case")
...
with executor_1.batch():
	for T in T_s:
		job = executor_1.submit(all_neg_exp, D = 400, teacher = w_teacher, rad = student[0], student = student[1], T = T, lr_1 = 1, lr_2 = 0.005 , steps = 8000, experiment_path = run_path)
		jobs.append(job)
...
with executor_2.batch():
	for T in T_s:
		job_2 = executor_2.submit(all_neg, D = 400, teacher = w_teacher, rad = student[0], student = student[1], T = T, lr_1 = 1, lr_2 = 0.005, steps = 8000, experiment_path = run_path)
		jobs_2.append(job_2)
